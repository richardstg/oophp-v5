...
class DiceControllerTest extends TestCase
{
    ...
    /**
     * Call the controller pre-game action.
     */
    public function testpregameActionGet()
    {
        $res = $this->controller->pregameActionGet();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
     ...
     * Call the controller pre-game action.
     */
    public function testpregameActionPost()
    {
        $res = $this->controller->pregameActionPost();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
     ...
     * Call the controller pre-game action.
     */
    public function testpregameresultsAction()
    {
        $res = $this->controller->pregameresultsAction();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
     ...
     * Call the controller pre-game action.
     */
    public function testnewroundActionPost()
    {
        $res = $this->controller->newroundActionPost();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
     ...
     * Call the controller pre-game action.
     */
    public function testplayerplayActionPost()
    {
        $res = $this->controller->playerplayActionPost();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
     ...
     * Call the controller pre-game action.
     */
    public function testplayerstopActionPost()
    {
        $res = $this->controller->playerstopActionPost();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
     ...
     * Call the controller pre-game action.
     */
    public function testroundresultsAction()
    {
        $res = $this->controller->roundresultsAction();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
     ...
     * Call the controller pre-game action.
     */
    public function testgameoverAction()
    {
        $res = $this->controller->gameoverAction();
        $this->assertInstanceOf(ResponseUtility::class, $res);
    }
